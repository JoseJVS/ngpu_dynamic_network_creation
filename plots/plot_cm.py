...
for i in range(len(nest_data)):
    ...
    plt.bar(x=nest_pos[i], height=nest_data[i]["time_connect"]["mean"], yerr=nest_data[i]["network_construction_time"]["std"], width=0.25, bottom=nest_data[i]["time_network"]["mean"]+nest_data[i]["time_create"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
...
for i in range(len(ngpu_main_data)):
    ...
    plt.bar(x=ngpu_main_pos[i], height=ngpu_main_data[i]["time_calibrate"]["mean"], yerr=ngpu_main_data[i]["network_construction_time"]["std"],width=0.2, bottom=ngpu_main_data[i]["time_connect"]["mean"]+ngpu_main_data[i]["time_network"]["mean"]+ngpu_main_data[i]["time_create"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
...
for i in range(len(ngpu_conn_data)):
    ...
    plt.bar(x=ngpu_conn_pos[i], height=ngpu_conn_data[i]["time_calibrate"]["mean"], yerr=ngpu_conn_data[i]["network_construction_time"]["std"], width=0.2, bottom=ngpu_conn_data[i]["time_connect"]["mean"]+ngpu_conn_data[i]["time_network"]["mean"]+ngpu_conn_data[i]["time_create"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})

genn_pos = [3.2, 3.5, 3.8]
genn_data = [genn_V100, genn_A100, genn_2080]
for i in range(len(genn_data)):
    plt.bar(x=genn_pos[i], height=genn_data[i]["time_build"]["mean"], yerr=genn_data[i]["network_construction_time"]["std"], width=0.2, bottom=genn_data[i]["time_model_def"]["mean"]+genn_data[i]["time_load"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
...
for i in range(len(ngpu_conn_data)):
    if i == 0:
        plt.bar(x=ngpu_conn_pos[i], height=ngpu_conn_data[i]["time_calibrate"]["mean"], yerr=ngpu_conn_data[i]["network_construction_time"]["std"], width=0.2, bottom=ngpu_conn_data[i]["time_connect"]["mean"]+ngpu_conn_data[i]["time_network"]["mean"]+ngpu_conn_data[i]["time_create"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
        plt.bar(x=ngpu_conn_pos[i], height=ngpu_conn_data[i]["time_calibrate"]["mean"], width=0.2, bottom=ngpu_conn_data[i]["time_connect"]["mean"]+ngpu_conn_data[i]["time_network"]["mean"]+ngpu_conn_data[i]["time_create"]["mean"], color = ngpu_colors[3], label = "Calibration")
...
for i in range(len(nest_data)):
    ...
    plt.bar(x=nest_pos[i], height=nest_data[i]["network_construction_time"]["mean"], yerr=nest_data[i]["network_construction_time"]["std"], width=0.25, color = "none", capsize=5, error_kw={"elinewidth": 2.25})
    ...
    plt.bar(x=nest_pos[i], height=nest_data[i]["time_simulate"]["mean"], yerr=nest_data[i]["time_simulate"]["std"], width=0.25, bottom=nest_data[i]["network_construction_time"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})

for i in range(len(ngpu_main_data)):
    plt.bar(x=ngpu_main_pos[i], height=ngpu_main_data[i]["network_construction_time"]["mean"], width=0.2, color = total_time_colors[0])
    plt.bar(x=ngpu_main_pos[i], height=ngpu_main_data[i]["network_construction_time"]["mean"], yerr=ngpu_main_data[i]["network_construction_time"]["std"], width=0.25, color = "none", capsize=5, error_kw={"elinewidth": 2.25})
    ...
    plt.bar(x=ngpu_main_pos[i], height=ngpu_main_data[i]["time_simulate"]["mean"], yerr=ngpu_main_data[i]["time_simulate"]["std"], width=0.2, bottom=ngpu_main_data[i]["network_construction_time"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})

for i in range(len(ngpu_conn_data)):
    plt.bar(x=ngpu_conn_pos[i], height=ngpu_conn_data[i]["network_construction_time"]["mean"], width=0.2, color = total_time_colors[0])
    plt.bar(x=ngpu_conn_pos[i], height=ngpu_conn_data[i]["network_construction_time"]["mean"], yerr=ngpu_conn_data[i]["network_construction_time"]["std"], width=0.25, color = "none", capsize=5, error_kw={"elinewidth": 2.25})
    ...
    plt.bar(x=ngpu_conn_pos[i], height=ngpu_conn_data[i]["time_simulate"]["mean"], yerr=ngpu_conn_data[i]["time_simulate"]["std"], width=0.2, bottom=ngpu_conn_data[i]["network_construction_time"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
...
for i in range(len(genn_data)):
    if i==0:
        ...
        plt.bar(x=genn_pos_L[i], height=genn_data[i]["network_construction_time"]["mean"], yerr=genn_data[i]["network_construction_time"]["std"], width=0.25, color = "none", capsize=5, error_kw={"elinewidth": 2.25})
        ...
        plt.bar(x=genn_pos_L[i], height=genn_data[i]["time_simulate"]["mean"], yerr=genn_data[i]["time_simulate"]["std"], width=0.1, bottom=genn_data[i]["network_construction_time"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
        plt.bar(x=genn_pos_R[i], height=genn_data[i]["network_construction_time_nobuild"]["mean"], width=0.1, color = total_time_colors[2], label="Network construction\nwithout Building")
        plt.bar(x=genn_pos_R[i], height=genn_data[i]["network_construction_time_nobuild"]["mean"], yerr=genn_data[i]["network_construction_time_nobuild"]["std"], width=0.25, color = "none", capsize=5, error_kw={"elinewidth": 2.25})
        ...
        plt.bar(x=genn_pos_R[i], height=genn_data[i]["time_simulate"]["mean"], yerr=genn_data[i]["time_simulate"]["std"], width=0.1, bottom=genn_data[i]["network_construction_time_nobuild"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
    else:
        ...
        plt.bar(x=genn_pos_L[i], height=genn_data[i]["time_simulate"]["mean"], yerr=genn_data[i]["time_simulate"]["std"], width=0.1, bottom=genn_data[i]["network_construction_time"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
        plt.bar(x=genn_pos_R[i], height=genn_data[i]["network_construction_time_nobuild"]["mean"], width=0.1, color = total_time_colors[2])
        plt.bar(x=genn_pos_R[i], height=genn_data[i]["network_construction_time_nobuild"]["mean"], yerr=genn_data[i]["network_construction_time_nobuild"]["std"], width=0.25, color = "none", capsize=5, error_kw={"elinewidth": 2.25})
        plt.bar(x=genn_pos_R[i], height=genn_data[i]["time_simulate"]["mean"], width=0.1, bottom=genn_data[i]["network_construction_time_nobuild"]["mean"], color = total_time_colors[1])
        plt.bar(x=genn_pos_R[i], height=genn_data[i]["time_simulate"]["mean"], yerr=genn_data[i]["time_simulate"]["std"], width=0.1, bottom=genn_data[i]["network_construction_time_nobuild"]["mean"], color = "none", capsize=5, error_kw={"elinewidth": 2.25})
