...
nest_path = Path("../data/nest_jureca/dc_input_benchmark")

genn_a100_path = Path("../data/genn_jureca")
genn_v100_path = Path("../data/genn_jusuf")
genn_2080_path = Path("../data/genn_jusuf") # TODO update when data is available

ngpu_main_a100_path = Path("../data/nestgpu_jureca/main_dc_input_benchmark")
ngpu_main_v100_path = Path("../data/nestgpu_jusuf/main_dc_input_benchmark")
ngpu_main_2080_path = Path("../data/nestgpu_jusuf/main_dc_input_benchmark") # TODO update when data is available

ngpu_conn_a100_path = Path("../data/nestgpu_jureca/conn_dc_input_benchmark")
ngpu_conn_v100_path = Path("../data/nestgpu_jusuf/conn_dc_input_benchmark")
ngpu_conn_2080_path = Path("../data/nestgpu_jusuf/conn_dc_input_benchmark") # TODO update when data is available
