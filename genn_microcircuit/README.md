...
These files were modified for benchmarking purposes:
 - [potjans_microcircuit_pygenn.py](potjans_microcircuit_pygenn.py):
   - Changed default value of BUILD_MODEL parameter (l38). By default its value is False which causes the simulation to fail if model was not previously built. Changed to True.
